    ...
    <div className="min-h-screen bg-base flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl">
          <h2 className="text-text font-semibold text-xl mb-1">Create account</h2>
          <p className="text-muted text-sm mb-6">Start building with SOEN</p>
          ...
          <form onSubmit={submit} className="flex flex-col gap-4">
            ...
            >
              {loading ? <><i className="ri-loader-4-line animate-spin mr-2"></i>Creating...</> : 'Create account'}
            </button>
          </form>
